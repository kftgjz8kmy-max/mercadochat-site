...
export const landing = {
  ...
  plans: [
    { name: "Vendedor", audience: "Para vendedores con una operación constante.", price: "149", setup: "Implementación única: S/249", cta: "Solicitar demo", items: ["1 cuenta de Mercado Libre", "Consultas de ventas y órdenes", "Información de productos y precios", "Consulta de publicaciones propias", "Investigación básica de productos", "Creación asistida de publicaciones", "Soporte estándar"] },
    { name: "Vendedor Pro", audience: "Para vendedores fuertes y tiendas con mayor volumen.", price: "299", setup: "Implementación única: S/499", featured: true, cta: "Elegir Vendedor Pro", items: ["Todo lo del plan Vendedor", "Mayor volumen de consultas", "Investigación frecuente de productos", "Comparación de publicaciones", "Uso recurrente para crear publicaciones", "Configuración personalizada para tu tienda", "Capacitación inicial", "Soporte prioritario", "Revisión mensual de funcionamiento"] },
    { name: "Agencia", audience: "Para agencias y operadores que administran varias cuentas.", price: "749", prefix: "Desde ", setup: "Implementación desde: S/1,200", cta: "Hablar sobre mi agencia", items: ["Hasta 3 cuentas de Mercado Libre", "Separación de información por cliente", "Consultas y acciones por cliente", "Configuración independiente por cuenta", "Capacitación para el equipo", "Incorporación asistida de cuentas", "Cuenta adicional: S/150/mes", "Soporte prioritario"] },
  ],
